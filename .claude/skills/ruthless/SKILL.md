...
- **Both markers present, version current:** governance is installed and up to date. Mention it briefly ("Ruthless governance block found in `CLAUDE.md`, v2 — active.") and continue.
