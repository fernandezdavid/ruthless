...
- **Both markers present, version current:** governance is installed and up to date. Mention it briefly ("Ruthless governance block found in `GEMINI.md`, v1 — active.") and continue.
